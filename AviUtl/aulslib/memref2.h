...
*	memref2.h by �֐F
*
*	memref.h ���������āAauls_memref.auf �ł͂Ȃ�
*	auls_memref.ini ����A�h���X���擾����悤�ɂ��܂����B
**/
#pragma once
...
public:
	...
	BOOL loadAddress(FILTER *fp)
	{
		try
		{
			// iniFilePath �ɃA�h���X�t�@�C���̃t�@�C���p�X���i�[����B
			...
			// appName �� exedit.auf �t�@�C���̃n�b�V���l���i�[����B
			TCHAR appName[MAX_PATH] = {};
			{
				// exedit.auf �t�@�C���̃t�@�C���p�X���i�[����B
				TCHAR path[MAX_PATH] = {};
